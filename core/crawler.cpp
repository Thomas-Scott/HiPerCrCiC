...
public:
	...
	void crawl(char * start, double max, QueueNode b, QueueNode a);
...
void Crawler::crawl(char * start, double max = 1000, QueueNode b, QueueNode a)
{
	/*
	setStartUrl(start);
...
{
	Crawler sharp;
	sharp.addBlacklist("http://www.bodyworkdynamics.com/");
